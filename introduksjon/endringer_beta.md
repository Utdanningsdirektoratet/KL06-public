...
- Status har endret format til [http://beta-data.udir.no/kl06/{statuskode}](http://beta-data.udir.no/kl06/statuskode), feks [http://beta-data.udir.no/kl06/status_publisert](http://beta-data.udir.no/kl06/status_publisert). Dette er nå en peker på status-elementet, og man kan hente mer informasjon om status (oversettelser etc)
- url-psi er fjernet
