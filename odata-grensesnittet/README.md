...
| UrlData | Url til detaljert informasjon om fagkoden for maskinell behandling | [http://data.udir.no/kl06/odata/Fagkode?$filter=(Psi eq 'uuid:59d5b28c-963b-40d4-bf41-eff7b333b424')&$select=UrlD&$select=UrlData&$format=json)ata&$format=json&$select=UrlData&$format=json)](http://data.udir.no/kl06/odata/Fagkode?$filter=%28Psi eq 'uuid:59d5b28c-963b-40d4-bf41-eff7b333b424'%29%26$select=UrlD%26$select=UrlData%26$format=json)ata%26$format=json%26$select=UrlData%26$format=json%29) |
