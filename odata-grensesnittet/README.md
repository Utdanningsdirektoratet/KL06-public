...
| --- | --- | --- |
| Tittel | Fagkodens tittel på default språk | http://data.udir.no/kl06/odata/Fagkode?$filter=startswith(Tittel,'Tverrfaglig') (Returnerer alle fagkoder hvis tittel starter med “_Tverrfaglig”)_ |
