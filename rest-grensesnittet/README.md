...
| [http://data.udir.no/kl06/{kode}/opplaeringsfag/fagtype=fagtype_felles_programfag{.format}](http://data.udir.no/kl06/XXXX/opplaeringsfag/fagtype=fagtype_felles_programfag) | Hent alle opplæringsfag for fag med presisering av fagtype | XML (.xml), JSON (.json) | [http://data.udir.no/kl06/AMB2002/opplaeringsfag/fagtype=fagtype_felles_programfag.json](http://data.udir.no/kl06/AMB2002/opplaeringsfag/fagtype=fagtype_felles_programfag.json)