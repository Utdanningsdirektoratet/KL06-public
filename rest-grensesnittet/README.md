...
| --- | --- | --- | --- |
| [http://data.udir.no/kl06/fagkoder{.format}{?lang=XXX}](http://data.udir.no/kl06/fagkoder%7b.format%7d%7b?lang=XXX%7d) | Henter ut alle fag i Grep | RSS/Atom (.atom) | [http://data.udir.no/](http://data.udir.no/kl06/fag)[kl06/fag](http://data.udir.no/kl06/fag)koder (gir tilbake alle fagkoder i standardformat) |
